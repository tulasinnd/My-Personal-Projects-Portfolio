...
def Skills():
    ...
    st.write("<div style='color:#99ff33; font-size:24px'>Database Management:</div>", unsafe_allow_html=True)
    ...
    st.write("<div style='color:#99ff33; font-size:24px'>Deployment:</div>", unsafe_allow_html=True)
    ...
    st.write("<div style='color:#99ff33; font-size:24px'>Machine Learning:</div>", unsafe_allow_html=True)
    ...
    st.write("<div style='color:#99ff33; font-size:24px'>Deep Learning:</div>", unsafe_allow_html=True)
    ...
    st.write("<div style='color:#99ff33; font-size:24px'>Streamlit:</div>", unsafe_allow_html=True)
    ...
    st.write("<div style='color:#99ff33; font-size:24px'>Exploratory Data Analysis:</div>", unsafe_allow_html=True)
    ...
    st.write("<div style='color:#99ff33; font-size:24px'>Feature Engineering:</div>", unsafe_allow_html=True)
